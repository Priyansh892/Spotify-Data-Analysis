...
utils = {
  authorize() {
    window.location =
      ...
      '?client_id=8641163b887b496cb3095ba28ca6e379' +
      '&redirect_uri=' +
...
window.onload = () => {
  ...
  if (dict.access_token) {
    ...
    logoutContainer.innerHTML =
      '<button id="logoutButton" style="background-color: #462066; margin-top: 14px; margin-bottom: 12px; color: white; type="submit" class="btn btn-lg" onclick="utils.logout()">Log Out</button>';
